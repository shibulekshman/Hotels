if(hsJsHost != ''){
	...
	if(hsJsKey != '' && hsJsHost != ''){
		...
		var encoded_ids = encode64(hsHotelIDs.replace(",","-").replace(" ",""));
		
		var filePath = 'widgets/ipanel-left/index.php?host='+encoded_host+'&key='+encoded_key+'&hids='+encoded_ids;
		
		// setup the iframe target
		var iframe='<iframe id="frame" name="widget" src="#" width="215px" height="330px" marginheight="0" marginwidth="0" frameborder="no" scrolling="no"></iframe>';
