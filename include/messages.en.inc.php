...
define("_CART_WAS_UPDATED","Reservation cart has been successfully updated!");
...
define("_DISCOUNT_STD_CAMPAIGN_TEXT","<span class=campaign_header>Super discount campaign!</span><br><br>Enjoy special price cuts in our Hotel for the specified periods of time below!");
...
define("_FIELD_VALUE_EXCEEDED","_FIELD_ has exceeded the maximum allowed value _MAX_! Please re-enter or change total rooms number <a href='index.php?admin=mod_rooms_management'>here</a>.");
...
define("_LEGEND_PENDING","The booking has been created has not yet been confirmed and reserved");
...
define("_MINIMUM_NIGHTS_ALERT","The minimum allowed stay for the period of time from _FROM_ to _TO_ is _NIGHTS_ nights per booking (package _PACKAGE_NAME_). Please re-enter.");
...
define("_OWNER","Owner");
define("_OWNER_NOT_ASSIGNED","You still has not been assigned to any hotel to see the reports.");
...
define("_ROOM_WAS_REMOVED","Selected room has been successfully removed from your Reservation Cart!");
define("_ROWS","Rows");
